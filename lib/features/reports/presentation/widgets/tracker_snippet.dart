    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(intake.label, style: Palette.dayViewBold),
              Spacer(),
              Text(
          ...
          Row(
            children: [
              if (intake.lowerLimit != null)
                Text(intake.lowerLimit!.toStringAsFixed(0), style: rangeStyle),
              Spacer(),
              if (intake.upperLimit != null)
                Text(intake.upperLimit!.toStringAsFixed(0), style: rangeStyle),
            ],
          ),
        ],
      ),
